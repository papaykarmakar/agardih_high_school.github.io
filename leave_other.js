document.getElementById("leaveForm").addEventListener("submit", function (e) {
    ...
    doc.setFontSize(12);
    doc.text("To the Headmaster/T.I.C.", 105, y, null, null, "center");
    y += 5;
    doc.setFontSize(12);
    doc.text("_________________________________", 105, y, null, null, "center");
    y += 5;
    doc.setFontSize(12);
    doc.text("_________________________________", 105, y, null, null, "center");
    ...
    y += 10;
    let body = `Respected _______,

with due respect and honour, I, ${name} (${designation}), beg to state that, due to ${reason}, I am unable to attend the school from ${fromDate} to ${toDate}.
